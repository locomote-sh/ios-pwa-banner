...
let bannerHtml = `
    <div class="ios-pwa-banner hide-element">
        ...
        <div class="banner-text">
            <span class="banner-text-one">Install APP to your home screen</span>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    //
    document.querySelector('#ios-pwa-banner').innerHTML = bannerHtml;

    // Get the app title from the header. This auto-generated by the locomote build-web-manifest
    // See: https://github.com/locomote-sh/build-web-manifest
    let appTitle = document.head.querySelector('[name=apple-mobile-web-app-title][content]').content || 'APP';
    // set text in the app
    document.querySelector('.banner-text-one').textContent = `Install ${appTitle} to your home screen`;

    //addElementClass('banner-text-two', 'hide-element');

    document.querySelector('.banner-text-one').text
